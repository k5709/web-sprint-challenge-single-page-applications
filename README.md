...
- [xx] A homepage that has a "/" route and links to your form (button, nav bar, or any other type of link is acceptable but must have an id of "order-pizza")
- [xx] A order form that has a "/pizza" route and shows the form
- [xx] A form with an id of "pizza-form"
- [xx] A name text input field with an id of "name-input"
...
- [xx] A dropdown for pizza size with an id of "size-dropdown"
- [xx] A checklist for toppings - at least 4 (hint: name each separately!)
- [xx] Text input for special instructions with an id of "special-text"
- [xx] An Add to Order button that has an id of "order-button" and that submits the form and returns a database record of name, size, toppings and special instructions
